    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiangmuPhoto" label="项目封面" prop="xiangmuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xiangmuPhoto?ruleForm.xiangmuPhoto:''"
                            @change="xiangmuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所属地点" prop="xiangmuAddress">
                       <el-input v-model="ruleForm.xiangmuAddress"
                                 placeholder="所属地点" clearable  :readonly="ro.xiangmuAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="所属地点" prop="xiangmuAddress">
                           <el-input v-model="ruleForm.xiangmuAddress"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="项目简介" prop="xiangmuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmuContent" label="项目简介" prop="xiangmuContent">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoTypes" label="项目审核" prop="xiangmuYesnoTypes">
                        <el-input v-model="ruleForm.xiangmuYesnoValue" placeholder="项目审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoText" label="审核结果" prop="xiangmuYesnoText">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //图片
            xiangmuPhotoUploadChange(fileUrls){
                this.ruleForm.xiangmuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
