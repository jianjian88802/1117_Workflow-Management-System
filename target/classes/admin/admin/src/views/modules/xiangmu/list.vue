        ...
        <el-dialog title="审核" :visible.sync="xiangmuYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.xiangmuYesnoTypes" placeholder="请选择审核类型">
                        <el-option label="通过" value="2"></el-option>
                        <el-option label="拒绝" value="3"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="审核意见">
                    <el-input type="textarea" v-model="form.xiangmuYesnoText" placeholder="审核意见"></el-input>
                </el-form-item>
            </el-form>
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('xiangmu','删除') && role == '管理员'"
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gongzuoliuchengguanli/upload/xiangmuMuBan.xls"
                        >批量导入项目信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xiangmu','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('xiangmu','修改') && ((userId == scope.row.yonghuId && scope.row.xiangmuYesnoTypes == 1) || role == '管理员')" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>

                            <el-button v-if="isAuth('xiangmu','删除') && ((userId == scope.row.yonghuId && scope.row.xiangmuYesnoTypes != 2) || role == '管理员')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
                            ...
                            <el-button v-if="isAuth('xiangmu','申请') && scope.row.xiangmuYesnoTypes == 2 && scope.row.yonghuId != userId" type="primary" icon="el-icon-thumb" size="mini" @click="shenqingxiangmu(scope.row.id)">申请加入项目</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			shenqingxiangmu(id){
				let data = {
					jiarudexiangmuYesnoTypes:1,
					xiangmuId:id
				}
				this.$confirm(`确定要申请加入这个项目?`, "提示", {
				    confirmButtonText: "确定",
				    cancelButtonText: "取消",
				    type: "warning"
				}).then(() => {
				    this.$http({
				        url: "jiarudexiangmu/save",
				        method: "post",
				        data: data
				    }).then(({data}) => {
				        if(data && data.code === 0){
            ...
            openYesnoTypes(id) {
                ...
                _this.form.xiangmuYesnoTypes = "请选择审核结果";
                _this.xiangmuYesnoTypesVisible = true;
            },

            xiangmuYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.xiangmuYesnoTypes == "请选择审核结果"){
                    alert("请选择审核结果");
                    return false;
                }
