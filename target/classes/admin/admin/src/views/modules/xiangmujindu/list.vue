        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('xiangmujindu','删除') && role == '管理员'"
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gongzuoliuchengguanli/upload/xiangmujinduMuBan.xls"
                        >批量导入项目进度数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xiangmujindu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xiangmujinduText"
                                      header-align="center"
                                      label="项目进度">
                        <template slot-scope="scope">
                            <span v-if="scope.row.xiangmujinduText != null &&scope.row.xiangmujinduText.length>10">
                                {{scope.row.xiangmujinduText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.xiangmujinduText}}
                            </span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('xiangmujindu','修改') && (role == '管理员' || scope.row.yonghuId == userId)" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('xiangmujindu','删除') && (role == '管理员' || scope.row.yonghuId == userId)" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
