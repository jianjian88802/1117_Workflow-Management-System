...
import center from '@/views/center'
    ...
    import jiarudexiangmu from '@/views/modules/jiarudexiangmu/list'
    import news from '@/views/modules/news/list'
    import xiangmu from '@/views/modules/xiangmu/list'
    import xiangmujindu from '@/views/modules/xiangmujindu/list'
    import addJiarudexiangmu from '@/views/modules/xiangmujindu/add-or-update'
	
    import yonghu from '@/views/modules/yonghu/list'
    import dictionaryJiarudexiangmuYesno from '@/views/modules/dictionaryJiarudexiangmuYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryJiarudexiangmuYesno',
        name: '加入审核',
        component: dictionaryJiarudexiangmuYesno
    }
    ,{
        path: '/dictionaryNews',
        name: '公告类型',
    ...
    ,{
	  ...
	  ,{
	      ...
	      name: '添加进度',
	      component: addJiarudexiangmu
	    }
	  
    ,{
        path: '/jiarudexiangmu',
        name: '加入的项目',
        component: jiarudexiangmu
      }
    ,{
        path: '/news',
        name: '公告信息',
