<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
				<el-col :span="12"  v-if="sessionTable !='xiangmu' && yanzheng == true">
				    <el-form-item class="select" v-if="type!='info'"  label="项目" prop="xiangmuId">
				        <el-select v-model="ruleForm.xiangmuId" :disabled="ro.xiangmuId" filterable placeholder="请选择项目" @change="xiangmuChange">
				            <el-option
            ...
            <input id="xiangmuId" name="xiangmuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="项目进度" prop="xiangmujinduText">
                        <el-input type="textarea"  :readonly="ro.xiangmujinduText" v-model="ruleForm.xiangmujinduText" placeholder="项目进度"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmujinduText" label="项目进度" prop="xiangmujinduText">
                            <span v-html="ruleForm.xiangmujinduText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
				if(this.$route.query.xiangmuId != null){
					this.xiangmuChange(this.$route.query.xiangmuId)
					this.ruleForm.xiangmuId = this.$route.query.xiangmuId
					this.yanzheng = false
				}
            }
         ...
         this.$http({
             url: `xiangmu/page?page=1&limit=100&yonghuId=`+this.userId,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
