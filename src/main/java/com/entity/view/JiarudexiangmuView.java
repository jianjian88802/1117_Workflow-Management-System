...
public class JiarudexiangmuView extends JiarudexiangmuEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 加入审核的值
		*/
		private String jiarudexiangmuYesnoValue;
	...
	public JiarudexiangmuView() {

	}

	public JiarudexiangmuView(JiarudexiangmuEntity jiarudexiangmuEntity) {
		try {
			BeanUtils.copyProperties(this, jiarudexiangmuEntity);
			...
			* 获取： 加入审核的值
			*/
			public String getJiarudexiangmuYesnoValue() {
				return jiarudexiangmuYesnoValue;
			}
			/**
			* 设置： 加入审核的值
			*/
			public void setJiarudexiangmuYesnoValue(String jiarudexiangmuYesnoValue) {
				this.jiarudexiangmuYesnoValue = jiarudexiangmuYesnoValue;
			}
